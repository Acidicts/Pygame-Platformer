...
class PhysicsEntity:
    ...
    def render(self, surf, offset=(0, 0)):
        x_off = self.pos[0] - offset[0] + self.anim_offset[0]
        y_off = self.pos[1] - offset[1] + self.anim_offset[1]
        surf.blit(pygame.transform.flip(self.animation.img(), self.flip, False), (x_off, y_off))
    ...
    def update(self, tile_map, movement=(0, 0)):
        ...
        if abs(self.game.player.dashing) >= 50:
            if self.rect().colliderect(self.game.player):
                ...
                self.game.sparks.append(Spark(self.rect().center, 0, 5 + random.random(), (255, 100, 100)))
                self.game.sparks.append(Spark(self.rect().center, math.pi + 0, 5 + random.random(), (255, 100, 100)))
                return True
